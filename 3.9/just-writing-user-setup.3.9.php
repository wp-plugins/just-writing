...
if( !function_exists( 'Just_Writing_User_Setup' ) )
	...
	*/
	Function Just_Writing_User_Setup( $user_id )
		...
		$JustWritingUtilities->store_user_option( 'quotes', 'on' );
		...
		$JustWritingUtilities->store_user_option( 'p_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h1_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h2_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h3_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h4_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h5_format', 'on' );
		$JustWritingUtilities->store_user_option( 'h6_format', 'on' );
		$JustWritingUtilities->store_user_option( 'address_format', 'on' );
		$JustWritingUtilities->store_user_option( 'pre_format', 'on' );
		...
		$JustWritingUtilities->store_user_option( 'add_DFWM_post_pages', 'on' );
		$JustWritingUtilities->store_user_option( 'disable_jscp', 'off' );
		$JustWritingUtilities->store_user_option( 'browser_fullscreen', 'off' );
